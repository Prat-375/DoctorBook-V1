  ...
  return (
    <div className="footer-container">
      <section className="footer-subscription">
        <p className="footer-subscription-heading">Join our Newsletter to receive updates regarding health guidelines</p>
        ...
        <div className="social-media-wrap">
          <div className="footer-logo">
            <Link to="/" className="social-logo">
              MedToVillage <i className="fab fa-typo3"></i>
            </Link>
          </div>
          <small className="website-rights">MedToVillage &copy; 2021</small>
